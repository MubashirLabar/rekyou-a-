...
function Home() {
    ...
    return (
        <div className='home-two'>
            <div className='banner rel' style={{backgroundImage: 'url(images/banner.jpg)'}}>
                <div className='cvr abs'/>
                <div className='wrapper flex aic'>
                    <div className='title font s36 b6 cfff'>Ta solution personnalisée</div>
                </div>
            </div>
            <div className='wrapper flex'>
                <div className='lit flex flex-col'>
                    <div className='title font s32 b6 c000'>Voici les services que nous te proponsons, tout compris en fonction de votre projet.</div>
                    
                    {/* Production */}
                    <div className='block'>
                        <div className='hdr flex aic'>
                            <button className='cleanbtn btn flex aic icon-minus s18 cfff' />
                            <div className='lbl font s18 b6 c000'>Production</div>
                        </div>
                        <div className='blk'>
                    ...
                    <div className='block'>
                        <div className='hdr flex aic'>
                            <button className='cleanbtn btn flex aic icon-minus s18 cfff' />
                            <div className='lbl font s18 b6 c000'>Promotion</div>
                        </div>
                        <div className='blk flex'>
                            <div className='item flex flex-col'>
                                <div className='log flex aic'><img src='/images/logo.svg' className='img'/></div>
                                <div className="txt font s14 c000">Nous te laissons profiter de <span className="b5">notre audience.</span> Manisfeste toi auprès de plus de <span className="b5">7000 passionnés, artistes, studios, maisons de disque & co.</span> Mais pas seulement, car avec RekYou c’est aussi <span className="b5">des articles de blog,</span> des <span className="b5">interviews,</span> ainsi que <span className="b5">l’intégration</span> de ton projet dans la playlist <span className="b5">Le FlaiR.</span></div>
                            </div>
                            <div className='item flex flex-col plus'>
                                <div className='log plus flex aic'><img src='/images/plus-icon.svg' className='img'/></div>
                            </div>
                            <div className='item flex flex-col'>
                                <div className='log flex aic'><img src='/images/groover-logo.svg' className='img'/></div>
                                <div className="txt font s14 c000">Profite de l’expérience de professionnels entièrement dédiés à l’écoute de ton projet et bénéficie de leur retour pour construire ton identité musicale.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='block'>
                        <div className='hdr flex aic'>
                            <button className='cleanbtn btn flex aic icon-minus s18 cfff' />
                            <div className='lbl font s18 b6 c000'>Distribution</div>
                        </div>
                        <div className='blk spin flex'>
                            <div className='item flex flex-col'>
                                <div className='log flex aic'><img src='/images/spinnup-logo.svg' className='img'/></div>
                ...
                <div className='rit flex flex-col rel'>
                    <div className={`block flex flex-col ${scroll > 300 && 'fix'} ${scroll > 900 && 'btm'}`}>
                        ...
                        <div className='blk flex flex-col aic'>
                            ...
                            <div className='btns flex aic'>
                                <button className='cleanbtn btn font s14 b3 cfff'>Oui</button>
                                <button className='cleanbtn btn font s14 b3 cfff'>Non</button>
                            </div>
                        </div>
                    </div>
                </div>
